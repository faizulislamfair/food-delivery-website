...
import { ACCENT_SECONDARY_COLOR,TERTIARY_COLOR } from '../../colors';
        ...
        <>
            <Container maxWidth="xl" sx={{
                ...
                <Grid container spacing={3} sx={{
                    ...
                    <Grid item md={5}  my={3}>
                        <input className='inputFld' placeholder='Enter your email *' />
                        <Grid container>
                            <Grid item md={9}>
                       ...
                       />
                        <span style={{fontSize:'12px'}}>
                            ...
                            <Grid item md={3}>
                            <Button
                                    sx={{ my: 2, mx: 3, color: '#fff', background: TERTIARY_COLOR }}
                                    variant="">
                                    Submit
                                </Button>
                            </Grid>
